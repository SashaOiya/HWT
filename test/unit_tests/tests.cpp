...
TEST(AVL_tree, copy_ctor) {
    my_tree::SearchTree<int> tree = {1, 2, 3, 4, 6, 7, 8, 12, 1};
    my_tree::SearchTree<int> lhs = tree;
...
TEST(AVL_tree, copy_assignment) {
    my_tree::SearchTree<int> tree = {3, 6, 9, 1, 5, 10, 22};
...
TEST(AVL_tree, move_ctor) {
    my_tree::SearchTree<int> tree = {-4, 9, 6, 4, -11, 0, 7, 4};
    ...
    my_tree::SearchTree<int> lhs = std::move(tree);
...
TEST(AVL_tree, move_assignment) {
    my_tree::SearchTree<int> tree = {5, 8, 9, 12, 3, -4, 67, 18};
